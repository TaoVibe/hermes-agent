...
class AIAgent:
    ...
    def flush_memories(self, messages: list = None, min_turns: int = None):
        ...
        try:
            ...
            if not _aux_available and self.api_mode == "codex_responses":
                ...
                codex_kwargs["tools"] = self._get_transport().convert_tools(
                    [memory_tool_def]
                )
        ...
        try:
            ...
            if self.api_mode == "codex_responses":
                ...
                if self.api_mode == "anthropic_messages":
                    ...
                    _sum_cc_nr = self._get_transport().normalize_response(
                        summary_response
                    )
            ...
            if final_response:
                ...
                if self.api_mode == "codex_responses":
                    ...
                    _retry_cc_nr = self._get_transport().normalize_response(
                        summary_response
                    )
    ...
    def run_conversation(
        ...
        _autonomy_resolution = resolve_autonomy_context(
            original_user_message if isinstance(original_user_message, str) else "",
            cwd=os.getcwd(),
            platform=getattr(self, "platform", None),
            has_conversation_history=bool(conversation_history),
        )
        _autonomy_block = build_autonomy_context_block(_autonomy_resolution)
        if _autonomy_block and isinstance(user_message, str):
